...
class C2CSendReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(7, _omitFieldNames ? '' : 'chatId', protoName: 'chatId')
    ..hasRequiredFields = false;
...
class C2CAckReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(5, _omitFieldNames ? '' : 'chatId', protoName: 'chatId')
    ..hasRequiredFields = false;
...
class ServerAckPush extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(4, _omitFieldNames ? '' : 'msgReceivedStatus',
        protoName: 'msgReceivedStatus')
    ..aOS(5, _omitFieldNames ? '' : 'ackTextDesc', protoName: 'ackTextDesc')
    ..aInt64(6, _omitFieldNames ? '' : 'receiveTime', protoName: 'receiveTime')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  void clearMsgReceivedStatus() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.String get ackTextDesc => $_getSZ(4);
  @$pb.TagNumber(5)
  set ackTextDesc($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasAckTextDesc() => $_has(4);
  @$pb.TagNumber(5)
  void clearAckTextDesc() => $_clearField(5);

  @$pb.TagNumber(6)
  $fixnum.Int64 get receiveTime => $_getI64(5);
  @$pb.TagNumber(6)
  set receiveTime($fixnum.Int64 value) => $_setInt64(5, value);
  @$pb.TagNumber(6)
  $core.bool hasReceiveTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearReceiveTime() => $_clearField(6);
}
